...
switch (command) {
    case 'Urgent': urgent (groceries, item)
    break;
    case 'Unnecessary': unnecessary (groceries,item)
    break;
    case 'Correct': correct (groceries,item, newItem) 
    break;
    case 'Rearrange': rearrange (groceries,item)
    break;
}
